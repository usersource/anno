...
- (id)initWithNibName:(NSString*)nibNameOrNil bundle:(NSBundle*)nibBundleOrNil
{
    ...
    if (self) {
        self.startPage = @"anno/pages/settings/main.html";
        level = 0;
        // Uncomment to override the CDVCommandDelegateImpl used
        // _commandDelegate = [[SettingsCommandDelegate alloc] initWithViewController:self];
        // Uncomment to override the CDVCommandQueue used
        // _commandQueue = [[SettingsCommandQueue alloc] initWithViewController:self];
    }
    return self;
}
...
@implementation SettingsCommandDelegate
...
@implementation SettingsCommandQueue
