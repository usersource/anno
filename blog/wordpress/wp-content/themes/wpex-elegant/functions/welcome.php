...
class WPEX_Welcome {
	...
	public function tabs() {
		...
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab <?php echo $selected == 'wpex-about' ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'wpex-about' ), 'index.php' ) ) ); ?>" title="<?php _e( "About", 'wpex' ); ?>">
				<?php _e( "About", 'wpex' ); ?>
			</a>
			<a class="nav-tab <?php if ( $selected == 'wpex-recommended' ) echo ' nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'wpex-recommended' ), 'index.php' ) ) ); ?>" title="<?php _e( 'Recommended', 'wpex' ); ?>">
				<?php _e( 'Recommended', 'wpex' ); ?>
			</a>
			<a class="nav-tab" href="http://www.wpexplorer.com/coupons/" title="<?php _e( 'Coupons & Deals', 'wpex' ); ?>" target="_blank"><?php _e( 'Coupons & Deals', 'wpex' ); ?></a>
		</h2>
		<?php
	}
		...
		<div class="wrap about-wrap">
			...
			<div>
				<div class="feature-section">
					...
					<div>
						<h4><?php _e( 'Total WordPress Theme', 'wpex' ); ?></h4>
